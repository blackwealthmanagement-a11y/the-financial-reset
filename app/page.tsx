...
import { ArrowRight, Building2, CheckCircle2, GraduationCap, LineChart, ShieldCheck, Sparkles } from 'lucide-react';
        ...
        <section className="hero">
          <div className="container hero-grid">
            <div className="hero-copy">
              ...
              <h1>Reset your credit. Rebuild your confidence.</h1>
